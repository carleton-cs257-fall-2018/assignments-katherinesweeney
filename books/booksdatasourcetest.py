...
class BooksDataSourceTest(unittest.TestCase):
    ...
    def test_authors(self):
        self.assertEqual(self.data.authors(), [{'id':1,'last_name':'Christie','first_name':'Agatha','birth_year':1890,'death_year':1976},
                                               ...
                                               {'id':20,'last_name':'Jemisen','first_name':'N.K.','birth_year':1972,'death_year':None}])

    def test_authors_book_id(self):
        self.assertEqual(self.data.authors(book_id=5), [{'id':5, 'last_name':'Gaiman', 'first_name':'Neil', 'birth_year':1960, 'death_year':None}])
    ...
    def test_authors_start_year(self):
        self.assertEqual(self.data.authors(start_year=2016), [{'id':5, 'last_name':'Gaiman', 'first_name':'Neil', 'birth_year':1960, 'death_year':None},
                                                              {'id':20,'last_name':'Jemisen','first_name':'N.K.','birth_year':1972,'death_year':None}])
    ...
    def test_authors_all_parameters(self):
        self.assertEqual(self.data.authors(start_year=1880, end_year=2017, search_text="c", book_id=6, sort_by="year"),[{'id': 6, 'last_name': 'Pratchett','first_name': 'Terry', 'birth_year': 1948,'death_year': 2015}])
