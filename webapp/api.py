...
def get_planets():
    ...
    pl_orbpermin = flask.request.args.get('pl_orbpermin', default=-1000, type=float)
    ...
    pl_orbsmaxmin = flask.request.args.get('pl_orbsmaxmin', default=-1000, type=float)
    ...
    pl_eccenmin = flask.request.args.get('pl_eccenmin', default=-10000, type=float)
    ...
    pl_massjmin = flask.request.args.get('pl_massjmin', default=-10000, type=float)
    ...
    pl_radjmin = flask.request.args.get('pl_radjmin', default=-10000, type=float)
