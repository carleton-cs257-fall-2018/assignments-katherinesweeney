...
var planet_search_fields = { "pl_name": "Name", "pl_hostname": "Planet's Host Star Name", "pl_discmethod": 'Discovery Method',
    "pl_pnum": "Number of Planets Orbiting Same Star", "pl_pnummax": "Max Number of Planets Orbiting Same Star", "pl_pnummin": "Min Number of Planets Orbiting Same Star",
    "pl_orbper": "Orbital Period (days)", "pl_orbpermax": "Max Orbital Period (days)", "pl_orbpermin": "Min Orbital Period (days)", "pl_orbsmax": "Orbit Semi-Major Axis (AU)",
    "pl_orbsmaxmax": "Max Orbit Semi-Major Axis (AU)", "pl_orbsmaxmin": "Min Orbit Semi-Major Axis (AU)", "pl_eccen": "Eccentricity", "pl_eccenmax": "Max Eccentricity",
    "pl_eccenmin": "Min Eccentricity", "pl_massj": "Mass (Jupiter Mass)", "pl_massjmax": "Max Mass (Jupiter Mass)", "pl_massjmin": "Min Mass (Jupiter Mass)",
    "pl_radj": "Radius (Jupiter Radii)", "pl_radjmax": "Max Radius (Jupiter Radii)", "pl_radjmin": "Min Radius (Jupiter Radii)", "pl_dens": "Density (g/cm^3)",
    "pl_densmax": "Max Density (g/cm^3)", "pl_densmin": "Min Density (g/cm^3)", "pl_ttvflag": "Orbit Exhibits TTV (Yes: 1; No: 0)",
    "pl_kepflag": "Found on Kepler Mission (Yes: 1; No: 0)", "pl_k2flag": "Found on Kepler2 Mission (Yes: 1; No: 0)", "pl_nnotes": "Number of Notes",
    "pl_nnotesmax": "Max Number of Notes", "pl_nnotesmin": "Min Number of Notes", "pl_facility": "Discovery Facility"}
...
function pick_criteria(criteria) {
    ...
    div.innerHTML = text+"<input type='text' class = 'text_box' name="+planet_search_fields[text]+"><button onclick='remove_parent_criteria(this)' type='button' class = 'x_button'>x</button>";
...
function make_table_right_side(selected, options) {
    table = document.getElementById('features_to_display');
    ...
    list = document.getElementById('add_feature');
...
function make_table_left_side(options) {
    table = document.getElementById('search_criteria');
    table.innerHTML = "<div class = 'inner_features_to_display big'>Search Criteria</div>";

    list = document.getElementById('add_criteria');
...
function click_star() {
    planet_button = document.getElementById("planet_buttton");
    star_button = document.getElementById("star_button");
